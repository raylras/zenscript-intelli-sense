...
import raylras.intellizen.languageserver.StandardIOLauncher.CLIENT
import raylras.intellizen.languageserver.provider.*
import raylras.intellizen.languageserver.util.fail
import raylras.intellizen.languageserver.util.finish
import raylras.intellizen.languageserver.util.info
import raylras.intellizen.languageserver.util.start
import raylras.intellizen.util.findUpwardsOrSelf
...
class ZenLanguageService : TextDocumentService, WorkspaceService {
    ...
    private fun String.toPath(): Path {
        return raylras.intellizen.util.toPath(this)
    }
    //endregion
}

...
fun Type?.test(target: Type?, env: CompilationEnvironment? = null): TypeTest {
    return when {
        this == null || target == null -> TypeTest.MISMATCH

        this == target -> TypeTest.EXACT

        this.isCastableTo(target, env) -> TypeTest.IMPLICIT

        else -> TypeTest.MISMATCH
    }
}

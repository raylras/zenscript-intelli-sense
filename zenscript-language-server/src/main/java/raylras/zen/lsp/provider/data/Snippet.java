...
public interface Snippet {
    ...
    static Snippet createFor(Type type, CompilationEnvironment env, ZenScriptParser.MemberAccessExprContext memberAccessExprContext) {
    ...
    static Snippet createForI(Type type, CompilationEnvironment env, ZenScriptParser.MemberAccessExprContext memberAccessExprContext) {
        Type iteratorType = Operators.getUnaryOperatorResult(type, Operator.ITERATOR, env);
    ...
    static Snippet createVal(ZenScriptParser.MemberAccessExprContext memberAccessExprContext) {
        return () -> Optional.of(createMemberCompletionItem(memberAccessExprContext, "val", "val name = expr", "val $1 = %s;"));
    }

    static Snippet createVar(ZenScriptParser.MemberAccessExprContext memberAccessExprContext) {
        return () -> Optional.of(createMemberCompletionItem(memberAccessExprContext, "var", "var name = expr", "var $1 = %s;"));
    }

    static Snippet createIfNull(Type type, ZenScriptParser.MemberAccessExprContext memberAccessExprContext) {
    ...
    static Snippet createIfNotNull(Type type, ZenScriptParser.MemberAccessExprContext memberAccessExprContext) {
        if (!(type instanceof NumberType || type == BoolType.INSTANCE || type == VoidType.INSTANCE)) {
    ...
    private static CompletionItem createMemberCompletionItem(ZenScriptParser.MemberAccessExprContext memberAccessExprContext, String name, String description, String snippet) {
